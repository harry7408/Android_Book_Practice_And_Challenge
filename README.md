...
※ ActionBar보다는 ToolBar 사용이 좋아보인다 (크기 조정과 같은 제약이 존재)<br></br>
...
>## Chapter 16
>- CriminalIntent 앱만 다시 만들 때 기록 작성
>
>## Chapter 17
>- 챌린지 1 : 날짜를 지역화 하기</br>
>- 
...
>## Chapter 18
>- 챌린지 1 : 범죄 리스트 접근성 개선하기</br>

> ※ CriminalIntent를 마무리하며
> - 앱이 총 11개의 파트로 호흡이 길고 중간에 잠시 멈춰서 다시 공부해야할 것 같다.</br>
> - Fragment와 관련된 8장, 12장의 내용을 잘 숙지하여 SingleActivity로 구성된 App을 만들 때 활용 </br>
> - 11장의 Room DB 의 스레드 -> 코루틴으로 확장하는 연습</br>
> - 17, 18 장의 리소스 관리 및 앱의 접근성을 높이는 부분을 더 심도있게 공부하여 사용자가 편하게 느끼도록 항상 고려해 봐야할 것 같다 </br>
